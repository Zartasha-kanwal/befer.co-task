        ...
        {activeTab === "email" ? (
          <div className="flex flex-col gap-[16px] ">
            ...
            <p className="text-[14px] text-[#1F1F1F] font-sans ">
              The fastest way to get up-and-running with Befer, our self-service
              cloud dashboard allows you to easily create and manage all your
              services, orders, and invoices.
            </p>
            <div>
          ...
          <div className="flex flex-col gap-[16px] max-h-full">
            <p className="text-[14px] font-sans">
              Enter your phone number to receive a verification code and sign in
              to your Befer account.
            </p>
            <div>
