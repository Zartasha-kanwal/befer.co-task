        ...
        <div className="relative bg-[#FFF] py-[24px] px-[28px] w-full rounded-3xl flex items-start justify-center overflow-hidden">
          ...
          <>
            ...
            <span className="text-[#6B7280] font-[16px] font-sans">
              Get started with Befer — your all-in-one dashboard for services,
              orders, and invoices.
            </span>
          </>
        ) : (
          <>
            ...
            {isCreateAccount ? (
              <CreateAccount scrollHeight={scrollHeight} scrollRef={scrollRef}/>
            ) : (
              <div
                ref={scrollRef}
                ...
                {activeTab === "email" ? (
                  <div className="flex flex-col gap-[16px] ">
                    ...
                    <p className="text-[14px] text-[#1F1F1F] font-sans ">
                      ...
                      self-service cloud dashboard allows you to easily create
                      and manage all your services, orders, and invoices.
                    </p>
                    <div>
            ...
            <p className="absolute bottom-0 pb-[20px] pt-[10px] text-[14px] font-sans text-[#374151] text-center bg-white w-full rounded-b-3xl">
              {isCreateAccount ? (
                <>
                  ...
                  <span
                    className="text-[#0058FF] cursor-pointer"
